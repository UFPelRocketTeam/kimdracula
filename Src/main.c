...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(lesd_GPIO_Port, lesd_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin : lesd_Pin */
  GPIO_InitStruct.Pin = lesd_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(lesd_GPIO_Port, &GPIO_InitStruct);
